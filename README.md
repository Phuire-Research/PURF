...
This is made possible thanks to the Unified Turing Machine that solves impossible halting problem of the classic. Accomplished by identifying that you can limit what appears in the finite symbol table of the classic turing machine, to only be that which is provably terminating. Or rather a table of concepts used to formalize a system of reasoning that effectively halts when a solution is found. As what is not addressed in the scope of general understanding, is the consequence of conceptual arrangements. Not only can arrangements of concepts out number the number of atoms in the universe. Is further compounded for each concept that comes into existence, a new set of possible variations emerges. As that concept can be composed with any other concept, including itself.
